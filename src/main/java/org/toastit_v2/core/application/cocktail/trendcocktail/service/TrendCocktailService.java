package org.toastit_v2.core.application.cocktail.trendcocktail.service;

import org.springframework.stereotype.Service;
import org.toastit_v2.core.application.cocktail.trendcocktail.port.TrendCocktailRepository;
...
public class TrendCocktailService implements TrendCocktailRepository {
    ...
    private final TrendCocktailJpaRepository jpaRepository;
    private final GoogleAPIRequestMaker googleAPIRequestMaker;
    private final NaverAPIRequestMaker naverAPIRequestMaker;

    public TrendCocktailService(TrendCocktailJpaRepository jpaRepository, GoogleAPIRequestMaker googleAPIRequestMaker, NaverAPIRequestMaker naverAPIRequestMaker) {
