package org.toastit_v2.core.ui.basecocktail;
...
public class CocktailController {
    ...
    @PostMapping
    public CocktailResponse createCocktail(@RequestBody CocktailCreateRequest request) {
        Cocktail created = cocktailService.createCocktail(request.toDomain());
        return CocktailResponse.from(created);
    }
}
