...
import org.toastit_v2.feature.aws.application.util.fileDeleter.ImageDeleter;
import org.toastit_v2.feature.aws.application.util.fileMover.ImageMover;
import org.toastit_v2.feature.aws.application.util.fileUploader.ImageUploader;
...
public class ImageServiceImpl implements ImageService {
    ...
    private final ImageMover imageMover;
    private final ImageDeleter imageDeleter;

    public ImageServiceImpl(
            ImageUploader imageUploader, ImageMover imageMover, ImageDeleter imageDeleter) {
    ...
    public String uploadFileToTemp(MultipartFile file) {
        return imageUploader.uploadFileToTemp(file);
    }
    ...
    public void moveTempToFinal(String fileName, String targetFolder) {
        imageMover.moveTempToFinal(fileName, targetFolder);
    }
    ...
    public void deleteImageFile(String FileName) {
        imageDeleter.deleteImage(FileName);
    }
    ...
    public String uploadProfileImage(MultipartFile file,int width, int height) {
        return imageUploader.uploadProfileImage(file,width,height);
    }
}
