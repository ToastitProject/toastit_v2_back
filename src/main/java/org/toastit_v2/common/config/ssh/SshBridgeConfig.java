package org.toastit_v2.common.config.ssh;
...
import org.toastit_v2.common.exception.custom.CustomSshBridgeException;
...
@Component
@Profile("dev")
public class SshBridgeConfig {

    private final Session session;

    public SshBridgeConfig(
        ...
        try {
            ...
            throw new CustomSshBridgeException(ExceptionCode.SSH_CONNECTION_ERROR);
        }
    }
